...
def main():
    ...
    parser.add_argument("--inputnii", dest="inputnii",
                        help="input segmentation from (nii.gz)", default=None, required=True)
    parser.add_argument("--movingnii", dest="movingnii",
                        help="second segmentation from (nii.gz)", default=None, required=False)
    parser.add_argument("--savetxt", dest="savetxt",
                        help="output landmark file to (txt)", default=None, required=False)
    ...
    if(d_options['savetxt'] is not None):
